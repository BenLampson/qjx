...
var Index = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["current"], _this.config = {
      ...
      _this.navigateTo(1);
    }, _this.handleCakeClicked = function () {
      _this.navigateTo(2);
  ...
  return Index;
}(_taroWeapp2.default.Component), _class.$$events = ["handleOrderClicked", "handleCakeClicked"], _class.$$componentPath = "pages/index/index", _temp2);
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=/Users/qijunxiang/wxAppProject/myApp/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/index/index.jsx?taro&type=template&parse=PAGE&":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
